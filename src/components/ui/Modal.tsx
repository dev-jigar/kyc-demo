  ...
  const modalContent = (
    ...
    >
      ...
      >
        ...
        <div
          className={classNames(
            "relative p-6 max-h-[calc(100vh-12rem)]",
        ...
        >
          ...
          {loading && (
            <div className="absolute inset-0 z-50 flex items-center justify-center bg-white/70 backdrop-blur-sm rounded-xl pointer-events-auto">
