...
import { EReverificationFrequency } from "@/src/types";
...
export const CancelReverificationModal: React.FC<
  CancelReverificationModalProps
> = ({ taskId, frequency, onClose, onConfirm }) => {
  const [cancelType, setCancelType] = useState<cancelReverificationType>(
    cancelReverificationType.request,
  );

  const isRecurring = frequency === EReverificationFrequency.Recurring;
