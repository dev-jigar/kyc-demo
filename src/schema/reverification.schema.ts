import { z } from "zod";
import { EReverificationFrequency, EReverificationRepeatUnit } from "../types";
import { endsTyp } from "../features/kyc/const";
...
const oneTimeSchema = baseSchema.extend({
  frequency: z.literal(EReverificationFrequency.OneTime),
...
const recurringBaseSchema = baseSchema.extend({
  frequency: z.literal(EReverificationFrequency.Recurring),
