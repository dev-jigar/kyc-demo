...
export function ContactCard({
  ...
  return (
    <Card>
      <div
        onClick={onClick}
        className="p-5 cursor-pointer transition hover:shadow-md hover:-translate-y-0.5"
      >
        {/* Header */}
        <div className="flex items-start justify-between">
          <div className="flex gap-3 items-center min-w-0">
            {/* Avatar */}
            <div className="h-10 w-10 flex-shrink-0 rounded-full bg-emerald-100 text-emerald-700 flex items-center justify-center font-semibold">
              {initials}
            </div>
